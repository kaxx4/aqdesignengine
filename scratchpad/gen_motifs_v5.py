...
async def piece_a():
    ...
    SW_ = [
        ...
        ("tag",     TOMATO, 214, ["DOG FEEDS"],          6, 22,  742),
        ("blob",    SKY,    166, ["SUNDAR", "BANS"],    -7, 34,  700),
        ("arch",    LEMON,  164, ["26", "DRIVES"],      -8, 33,  876),
        ("shield",  MINT,   152, ["DISHA"],             11, 22,  330),
        ("blob",    PINK,   144, ["SINCE", "2021"],     -9, 33,  118),
        ("scallop", SKY,    150, ["KOLKATA"],            8, 22,  846),
    ]
    ...
    # Placed against the three REAL line boxes now. The last line ("SHOWING UP.")
    # is the punchline and stays clear: nothing sits on it below 45% visibility.
    ys = [hy - 122, hy - 96, hy + 122, hy + 92, hy - 70, hy + 250,
          hy + 300, hy + 384, hy + 408, hy + 156]
    zs = [12, 28, 28, 28, 12, 28, 12, 28, 28, 12]
    for (kind, fill, size, lines, rot, _fs, x), y, z in zip(SW_, ys, zs):
        ...
        ZED.append((f"stk{x}", lay.rotated_bbox(x, y, size, size, rot), z))
