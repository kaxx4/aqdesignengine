...
async def main():
    async with B.session():
        ...
        hero_w, hero_h = M_HERO["glyph_w"] + 140, M_HERO["glyph_h"] + 100
        ...
        photo_x, photo_y, photo_w, photo_h = 230, 640, 620, 440
        ...
        inner = "".join([
            ...
            f'<div class="measure" data-tag="photo" style="position:absolute;left:{photo_x}px;'
        ...
        await B.render(html, f"{outdir}/g2_v2.png", W, H, elements=elements,
        ...
        print("done -> out/session10g/g2_v2.png")
