...
async def build():
    ...
    dood_size = 130
    dood_x, dood_y = 150, 1330
    dood_col = core.on_dark(core.ACCENTS[0], 130, True)   # pink, checked against ink
    ...
    async with B.session():
        issues = await B.render(html, f"{outdir}/g4_v3.png", W, H,
