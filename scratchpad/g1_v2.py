"""Workflow C -- bespoke FRESH poster, v2. See g1_v1.py for the full brief/style/content
writeup -- unchanged. This version fixes what the looking gate (CLAUDE.md sec3) caught on v1:
...
async def main():
    ...
    out_png = "out/session10g/g1_v2.png"
