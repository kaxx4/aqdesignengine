...
async def piece_a():
    ...
    SW_ = [
        ...
        ("tag",     TOMATO, 214, ["DOG FEEDS"],          6, 22,   74),
    ...
    m = await B.measure_text(
        [{"text": "WE JUST<br>KEEP<br>SHOWING UP.", "font": "d", "size": 152,
          "weight": 900, "line_height": .86, "max_width": W - 2 * M}]
        + [{"text": t, "font": "d", "size": 152, "weight": 900} for t in HEAD_LINES])
    head_h = m[0]["h"]
    ...
    ys = [hy - 118, hy - 92, hy + 128, hy + 96, hy + 436, hy + 236,
          hy + 318, hy + 396, hy + 424, hy + 150]
    zs = [12, 28, 28, 28, 28, 28, 12, 28, 28, 12]
