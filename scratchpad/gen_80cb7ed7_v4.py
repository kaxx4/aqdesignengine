...
WAYPTS_SRC = [(681, -40), (660, 20), (650, 60), (660, 110), (700, 160), (820, 175),
              (950, 178), (1080, 175), (1160, 195), (1180, 230), (1165, 270),
              (1080, 300), (950, 310), (820, 320), (700, 340),
...
async def main():
    ...
    await B.render(html, f"out/versions/{SLUG}/v4.png", W, H, elements=elements,
                   color_pairs=color_pairs, page_bg="var(--bg)", expect_hero=True,
                   collision_ignore=COLLISION_IGNORE, bleed_tags=("ribbon",))
    print("done -> out/versions/%s/v4.png" % SLUG)
