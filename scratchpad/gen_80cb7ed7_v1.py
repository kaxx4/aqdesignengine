...
WAYPTS_SRC = [(680, -40), (650, 60), (900, 150), (1106, 240), (900, 340),
              (635, 440), (750, 520), (1105, 640), (1150, 715)]
...
async def main():
    ...
    await B.render(html, f"out/versions/{SLUG}/v1.png", W, H, elements=elements,
                   color_pairs=color_pairs, page_bg="var(--bg)", expect_hero=True,
                   collision_ignore=COLLISION_IGNORE, bleed_tags=("ribbon",))
    print("done -> out/versions/%s/v1.png" % SLUG)
