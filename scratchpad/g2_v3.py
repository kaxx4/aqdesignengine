...
async def main():
    async with B.session():
        ...
        hero_w, hero_h = M_HERO["glyph_w"] + 140, M_HERO["glyph_h"] + 124
        ...
        ws_w, ws_h = M_WS["glyph_w"] + 120, M_WS["glyph_h"] + 114
        ...
        await B.render(html, f"{outdir}/g2_v3.png", W, H, elements=elements,
        ...
        print("done -> out/session10g/g2_v3.png")
