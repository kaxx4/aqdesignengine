...
CARD_BG = CREAM  # TEST ONLY: reverting to bg colour to isolate the card's scoring impact                  # warm light-grey "paper" -- see note below.
...
async def main():
    ...
    async with B.session():
        await B.render(html, f"{outdir}/_test_cardbg_same.png", W, H, elements=els, color_pairs=color_pairs,
                        page_bg=CREAM, expect_hero=True, collision_ignore=frozenset(CONTAINMENT_IGNORE))
    print("done ->", f"{outdir}/_test_cardbg_same.png")
