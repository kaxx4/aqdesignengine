...
clipped("bleed_bl_pages", 0, 390, 156, 110, "0% 0%, 100% 22%, 28% 100%, 0% 100%",
...
async def main():
    ...
    async with B.session():
        await B.render(html, f"{outdir}/v9.png", W, H, elements=els, color_pairs=color_pairs,
                        page_bg=CREAM, expect_hero=True, collision_ignore=frozenset(CONTAINMENT_IGNORE))
    print("done ->", f"{outdir}/v9.png")
