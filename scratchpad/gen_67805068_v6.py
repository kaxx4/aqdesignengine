...
67805068493b4522f5c3944723bee7d2.jpg), v6.
...
async def build():
    ...
    ring = [
        ...
        ("flowerA",      S.blob(seed=3, lobes=8, wobble=0.36),                 A[1], 0.11, 0.15,  0.175, -8,  22),
        ...
        ("animalPink",   S.capsule(w=100, h=60),                              A[0], 0.735,0.455, 0.195,  16,  22),
    ...
    out_png = f"out/versions/{slug}/v6.png"
