...
clipped("bleed_rmid_flowers", 960, 302, 107, 257, "35% 0%, 100% 0%, 100% 100%, 0% 100%",
...
async def main():
    ...
    async with B.session():
        await B.render(html, f"{outdir}/v7.png", W, H, elements=els, color_pairs=color_pairs,
                        page_bg=CREAM, expect_hero=True, collision_ignore=frozenset(CONTAINMENT_IGNORE))
    print("done ->", f"{outdir}/v7.png")
