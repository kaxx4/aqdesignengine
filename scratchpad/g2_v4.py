...
async def main():
    async with B.session():
        ...
        photo_x, photo_y, photo_w, photo_h = 230, 670, 620, 410  # y 640->670: ws_plate grew taller and collided
        ...
        await B.render(html, f"{outdir}/g2_v4.png", W, H, elements=elements,
        ...
        print("done -> out/session10g/g2_v4.png")
