...
67805068493b4522f5c3944723bee7d2.jpg), v8.
...
async def build():
    ...
    ring = [
        ...
        ("flowerPink",   S.scallop(lobes=9, r=44),                             A[0], 0.825,0.40,  0.165,  0,  20),
        ...
        ("flowerBrown",  S.scallop(lobes=8, r=44),                            BROWN_DK,0.755,0.615,0.115,-6,  20),
        ...
        ("fillerGap",    S.starburst(points=5, R=48, r=22),                    A[3], 0.435,0.475, 0.09,  15,  20),
    ]
    ...
    out_png = f"out/versions/{slug}/v8.png"
